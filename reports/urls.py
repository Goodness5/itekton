...
from .views import TransitReportInitialView, TransitReportUpdateView,  ReminderInitialView, ReminderUpdateView, AlertInitialView, AlertUpdateView, CriticalFaultInitialView, CriticalFaultUpdateView, TestInitialView, TestUpdateView
