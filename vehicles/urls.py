...
from .views import VehicleListView, VehicleDetailView, DriverListView, DriverDetailView, LocationListView, LocationDetailView, LatestLocationView, VehicleLocationAssignmentView, unassign_driver_from_vehicle, assign_driver_to_vehicle
